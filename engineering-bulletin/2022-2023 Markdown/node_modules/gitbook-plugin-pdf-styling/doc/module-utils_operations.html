...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Module: utils/operations</title>
...
<div id="main">
    ...
    <h1 class="page-title">Module: utils/operations</h1>
...
<article>
    <div class="container-overview">
            ...
            <div class="description"><p><strong>Operations which can be performed on a post-processed book.</strong></p>
<p>All functions expect their context to be set to the <code>book</code> instance.</p></div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="lib_operations.js.html">lib/operations.js</a>, <a href="lib_operations.js.html#line1">line 1</a>
    </li></ul></dd>
        ...
        <dl>
            <dt><a href="module-utils_operations-Operations.html">Operations</a></dt>
            <dd></dd>
        </dl>
